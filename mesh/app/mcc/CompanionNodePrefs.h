// GENERATED by tools/import_companion.py from MeshCore's examples/companion_radio/NodePrefs.h
...
class CompanionNodePrefs : public ConfigSerializer {  // persisted to file
public:
...
private:
  ...
  public:
    RadioPrefs(CompanionNodePrefs* parent) : _parent(parent) { }
  };
  RadioPrefs radio;
  ...
  public:
    GPSPrefs(CompanionNodePrefs* parent) : _parent(parent) { }
  };
  GPSPrefs gps;
  ...
  public:
    CompanionPrefs(CompanionNodePrefs* parent) : _parent(parent) { }
  };
...
public:
  CompanionNodePrefs() : radio(this), gps(this), companion(this) {
    node_name[0] = 0;
